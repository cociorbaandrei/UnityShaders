Shader "Skuld/Basics2/LightmappedDualTexture"
{
	Properties
	{
		...
		[Toggle]_Unlit("Layer 1 Unlit",Float) = 0
		_NormalTex("Layer 1 Normal Map", 2D) = "black" {}
		_NormalScale("Layer 1 Normal Amount", Range(0,1)) = 1.0
		_Smoothness("Layer 1 Smoothness", Range(0,1)) = .5
		_Reflectiveness("Layer 1 Reflectiveness",Range(0,1)) = 1
		[KeywordEnum(Lerp,Multiply,Additive)] _ReflectType("Layer 1 Reflection Type",Float) = 0
